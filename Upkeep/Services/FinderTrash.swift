...
enum UserTrashMove {
  ...
  private static func makeTrashBundleDirectory(
    ...
    let bundleName = "Upkeep_\(formatter.string(from: Date()))_\(UUID().uuidString)"
